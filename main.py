...
for codec in codecs:
    ...
    subprocess.run(['ls out/Build/Products/Release/'])
    subprocess.run(['mv', 'out/Build/Products/Release/AppleALC-1.7.6-RELEASE.zip', f'../Kexts/{codec}.zip'], capture_output=not args.verbose)
